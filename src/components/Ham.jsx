...
function Ham(props) {
  ...
  return (
    <div className={`fixed top-0 right-0 bg-white h-screen w-[90%] sm:w-[50%] transform ease-linear transition-transform duration-200 ${props.menu ? 'translate-x-0' : 'translate-x-full'}`}>
      ...
      <ul className='flex flex-col justify-center pt-14 items-start px-6 gap-4'>
